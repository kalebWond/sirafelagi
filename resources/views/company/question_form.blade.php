<form id="q_form" action="/company/question/{{$exam}}" method="POST">
  {{csrf_field()}}
    <div class="input-field col s12">
      ...
      <label for="question_nq" style="color: black;">Question</label>
    </div>
    <div class="input-field col s6">
      <input id="choices.0_nq" type="text" name="choices[]">
      <label for="choices.0_nq" style="color: black;">Choice A</label>
    </div>
    <div class="input-field col s6">
      <input id="choices.1_nq" type="text" name="choices[]">
      <label for="choices.1_nq" style="color: black;">Choice B</label>
    </div>
    <div class="input-field col s6">
      <input id="choices.2_nq" type="text" name="choices[]">
      <label for="choices.2_nq" style="color: black;">Choice C</label>
    </div>
    <div class="input-field col s6">
      <input id="choices.3_nq" type="text" name="choices[]">
      <label for="choices.3_nq" style="color: black;">Choice D</label>
    </div>
    <div class="input-field col s8">
        ...
        <label style="color: black;">Right Answer</label>
    </div>
